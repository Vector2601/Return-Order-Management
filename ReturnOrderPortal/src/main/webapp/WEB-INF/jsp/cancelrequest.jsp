...
<body>
	...
	<div class="container">
		<div class="row" id="main">
			<div class="col-sm">
				<h1 id="heading">Cancel a request</h1>
			</div>
		...
		<div class="row">
			...
			<div class="col-md" id="login-form">
				<form role="form" method="POST" action="/reversePayment" class="needs-validation" novalidate>
					<div class="form-row">
						<div class="col-md-6">
							<div class="form-group">
							<label for="requestId">Request Id</label><span>
									*</span> <input type="text" class="form-control"
									name="requestId" id="requestId"
									placeholder="Enter Request Id" value=""
									required="required"/>
									</div>
									<div class="form-group">
							...
							<!-- <div class="form-group">
							<label for="processingCharges">Processing Charges</label><span>
									*</span> <input type="text" class="form-control"
									name="processingCharges" id="processingCharges"
									placeholder="Enter Processing charges" value=""
									required="required"/>
							</div> -->
